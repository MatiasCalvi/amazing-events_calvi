...
function htmlCard(array, ruta) {
  ...
  >
    <img
      ...
      alt="${array.name}"
    />
    <div class="card-body marginCardBody"style="height:20rem">
...
function htmlDetails(obj,frase,propiedad) {
        ...
        <div class="row g-0">
          ...
          <div class="col-md-6">
            <div class="card-body">
              ...
              <p class="text-center fs-5" style="padding-right:5%"><span class="fw-bold">${frase}: </span>${obj[propiedad]}</p>
